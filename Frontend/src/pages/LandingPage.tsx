    ...
    <>
      <div className="min-h-screen animate-bg flex flex-col text-white font-sans">
        ...
        <header className="h-24 flex justify-between items-center px-6 w-full relative z-50">
          ...
          <button onClick={() => navigate('/dashboard')} className="flex items-center gap-2 bg-white/10 hover:bg-white/20 transition-all px-5 py-2.5 rounded-full border border-white/20 backdrop-blur-md shadow-lg">
